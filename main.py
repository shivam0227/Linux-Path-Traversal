...
def cd():
    ...
    elif dir in dir_list and dir in path_list:
...
def ls():
    global path_list
    # checking if path list is equal to root list or not if yes than we assign directory list to path list and print path list
    if path_list == root:
        path_list = dir_list
